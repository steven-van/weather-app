...
const weatherDetails = {
    ...
    56: { title: "Light Freezing Drizzle", icon: "material-symbols:weather-snowy-outline" },
    57: { title: "Freezing Drizzle", icon: "material-symbols:weather-snowy-outline" },
    ...
    66: { title: "Light Freezing Rain", icon: "material-symbols:weather-snowy-outline" },
    67: { title: "Freezing Rain", icon: "material-symbols:weather-snowy-outline" },
    71: { title: "Light Snow", icon: "material-symbols:weather-snowy-outline" },
    73: { title: "Snow", icon: "material-symbols:weather-snowy-outline" },
    75: { title: "Heavy Snow", icon: "material-symbols:weather-snowy-outline" },
    77: { title: "Snow Grains", icon: "material-symbols:weather-snowy-outline" },
    ...
    85: { title: "Light Snow Showers", icon: "material-symbols:weather-snowy-outline" },
    86: { title: "Snow Showers", icon: "material-symbols:weather-snowy-outline" },
